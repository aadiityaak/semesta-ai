...
// Register REST Route
function semesta_ai_register_rest_route() {
    register_rest_route( 'semesta-ai/v1', '/generate', array(
        'methods' => 'POST',
        'callback' => 'semesta_ai_generate_content',
        'permission_callback' => '__return_true', // You might want to restrict this to logged-in users or specific nonces
    ));
}
add_action( 'rest_api_init', 'semesta_ai_register_rest_route' );

// Callback Function
function semesta_ai_generate_content( $request ) {
